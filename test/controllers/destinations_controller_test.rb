...
class DestinationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post destinations_url, params: { destination: { categories: @destination.categories, names: @destination.names, prices: @destination.prices, references: @destination.references } }
    end
  ...
  test "should update destination" do
    patch destination_url(@destination), params: { destination: { categories: @destination.categories, names: @destination.names, prices: @destination.prices, references: @destination.references } }
