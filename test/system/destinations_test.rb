...
class DestinationsTest < ApplicationSystemTestCase
  ...
  test "creating a Destination" do
    ...
    fill_in "Categories", with: @destination.categories
    fill_in "Names", with: @destination.names
    fill_in "Prices", with: @destination.prices
    fill_in "References", with: @destination.references
